...
(function ($) {
    ...
    function _305(_306, _307, _308) {
        ...
        function _30b(dir) {
            ...
            var p = $("<div></div>").appendTo(_306).panel({cls: "layout-expand", title: "&nbsp;", closed: true, doSize: false, tools: [
...
(function ($) {
    ...
    ], showGroup: false, groupField: "group", groupFormatter: function (_63b, rows) {
        return _63b;
    }});
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {panelWidth: 180, panelHeight: "auto", keyHandler: {up: function () {
        ...
        _7c2(this, q);
    }}, currentText: "Dziś", closeText: "Zamknij", okText: "Ok", formatter: function (date) {
    ...
    function _7d7(_7de, _7df, _7e0) {
        ...
        if (!_7e0) {
            if (_7df) {
                ...
                if (_7de.id == "datetimebox_start") {
                    $("#datastartu").val(_7df);
                } else if (_7de.id == "datetimebox_end") {
                    $("#datazakonczenia").val(_7df);
                }
